      ...
      <div className="flex w-full flex-col justify-between gap-12 md:flex-row">
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            ...
            who specializes in frontend development (React.js, Next.js and React
            Native). I am enthusiastic about bringing the technical and visual
          ...
          <Typography>
            ...
            in my early thirties, I&apos;m building cutting-edge web
            applications using modern technologies such as Next.js, TypeScript,
            MaterialUI, Tailwindcss, Redux, Sagas, Redux-Toolkit and much more.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            journey of early startups or enjoying some free time. */}
          ...
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">M.C.A. in Computer Science</Typography>
              <Typography component="li">Full time freelancer</Typography>
            </ul>
            <ul className="flex list-inside list-disc flex-col gap-2">
              <Typography component="li">Avid learner</Typography>
              <Typography component="li">Aspiring indie hackers</Typography>
            </ul>
          </div>
          <Typography>
